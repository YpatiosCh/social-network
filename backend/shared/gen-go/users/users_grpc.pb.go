...
func (UnimplementedUserServiceServer) AreFollowingEachOther(context.Context, *FollowUserRequest) (*AreFollowingEachOtherResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AreFollowingEachOther not implemented")
}
...
func (UnimplementedUserServiceServer) GetGroupBasicInfo(context.Context, *IdReq) (*Group, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetGroupBasicInfo not implemented")
}
...
func (UnimplementedUserServiceServer) GetAllGroupMemberIds(context.Context, *IdReq) (*Ids, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllGroupMemberIds not implemented")
}
...
func (UnimplementedUserServiceServer) RemoveImages(context.Context, *FailedImageIds) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RemoveImages not implemented")
}
