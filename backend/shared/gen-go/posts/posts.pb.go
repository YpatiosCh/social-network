...
const file_posts_proto_rawDesc = "" +
	...
	"\x06offset\x18\x03 \x01(\x05R\x06offset\"\xdd\x03\n" +
	"\x04Post\x12\x17\n" +
	...
	"\faudience_ids\x18\x05 \x01(\v2\x0f.common.UserIdsR\vaudienceIds\x12\x14\n" +
	...
	"\x05limit\x18\x03 \x01(\x05R\x05limit\x12\x16\n" +
	"\x06offset\x18\x04 \x01(\x05R\x06offset\"\xd4\x02\n" +
	"\aComment\x12\x1d\n" +
	"\n" +
	...
	"\x04body\x18\x03 \x01(\tR\x04body\x12\x14\n" +
	"\x05image\x18\x04 \x01(\x03R\x05image\"\xda\x03\n" +
	"\x05Event\x12\x19\n" +
	...
	"\x05going\x18\x03 \x01(\bR\x05going2\xc6\n" +
	"\n" +
	"\fPostsService\x12-\n" +
	"\vGetPostById\x12\x11.posts.GenericReq\x1a\v.posts.Post\x12:\n" +
	"\n" +
	...
	"\x16ToggleOrInsertReaction\x12\x11.posts.GenericReq\x1a\x16.google.protobuf.EmptyB*Z(social-network/shared/gen-go/posts;postsb\x06proto3"
...
var file_posts_proto_goTypes = []any{
	...
	(*GenericReq)(nil),             // 1: posts.GenericReq
	(*EntityIdPaginatedReq)(nil),   // 2: posts.EntityIdPaginatedReq
	(*GenericPaginatedReq)(nil),    // 3: posts.GenericPaginatedReq
	(*Post)(nil),                   // 4: posts.Post
	(*ListPosts)(nil),              // 5: posts.ListPosts
	(*CreatePostReq)(nil),          // 6: posts.CreatePostReq
	(*EditPostReq)(nil),            // 7: posts.EditPostReq
	(*GetUserPostsReq)(nil),        // 8: posts.GetUserPostsReq
	(*GetPersonalizedFeedReq)(nil), // 9: posts.GetPersonalizedFeedReq
	(*GetGroupPostsReq)(nil),       // 10: posts.GetGroupPostsReq
	(*Comment)(nil),                // 11: posts.Comment
	(*ListComments)(nil),           // 12: posts.ListComments
	(*CreateCommentReq)(nil),       // 13: posts.CreateCommentReq
	(*EditCommentReq)(nil),         // 14: posts.EditCommentReq
	(*Event)(nil),                  // 15: posts.Event
	(*ListEvents)(nil),             // 16: posts.ListEvents
	(*CreateEventReq)(nil),         // 17: posts.CreateEventReq
	(*EditEventReq)(nil),           // 18: posts.EditEventReq
